...
// end include: /tmp/tmptgfezjju.js
...
var ASM_CONSTS = {
  747136: () => { FS.syncfs( false, function(err) { assert(!err); }); },  
 747188: () => { FS.mkdir('/cwd'); FS.mount(IDBFS, {}, '/cwd'); FS.syncfs( true, function(err) { assert(!err); _setupDoneImpl(); }); }
};
var wasmImports = {
  /** @export */
