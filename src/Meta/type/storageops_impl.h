...
#define STORAGEOPS_BEGIN(T) \
    STORAGEOPS_BEGIN_EX(, T)

#define STORAGEOPS_BEGIN_EX(Idx, T)                                                                     \
    namespace Engine {                                                                                  \
...
#define STORAGEOPS_INSTANTIATION(Idx, T)                                                                                                                             \
    ...
    DLL_EXPORT_VARIABLE(constexpr, const ::Engine::Type::StorageOps, , storageOps, SINGLE_ARG({ #T, ::Engine::type_holder<T>, Meta_##T::sCtors.data(nullptr) }), T); \
    namespace Meta_##T                                                                                                                                               \
    {                                                                                                                                                                \
        static ::Engine::Type::__Type_impl__::StorageOpsRegistrator<T> __areg;                                                                                       \
    }
