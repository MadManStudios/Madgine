...
Additionally, log listeners can be attached to logs to be notified of any messages. The :ref:`LogViewer` is one of those listeners. It stores all received messages and provides a filterable and sortable graphical representation of all messages within the Engine.
