...
#define IM_VEC2_CLASS_EXTRA                                                        \
    ImVec2(const Engine::Math::Vector2 &f)                                         \
    {                                                                              \
        x = f.x;                                                                   \
        y = f.y;                                                                   \
    }                                                                              \
    operator Engine::Math::Vector2() const { return Engine::Math::Vector2(x, y); } \
    ImVec2(const Engine::Math::Vector2i &f)                                        \
    {                                                                              \
...
#define IM_VEC4_CLASS_EXTRA                \
    ImVec4(const Engine::Math::Vector4 &f) \
    {                                      \
        x = f.x;                           \
        y = f.y;                           \
        z = f.z;                           \
    ...
    operator Engine::Math::Vector4() const { return Engine::Math::Vector4(x, y, z, w); }
