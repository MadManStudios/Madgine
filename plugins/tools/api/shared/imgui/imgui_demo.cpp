...
static void DemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Stack Layout")) {
        ...
        ImGui::SameLine();
        ImGui::ColorButton("- Spring", ImColor(80, 20, 80), ImGuiColorEditFlags_NoTooltip | ImGuiColorEditFlags_NoPicker);
        ImGui::SameLine();
        ImGui::TextUnformatted("Spring");
        ImGui::SameLine();
        ImGui::TextUnformatted(" ");
        ImGui::SameLine();
        ImGui::ColorButton("- Spacing", ImColor(80, 20, 20), ImGuiColorEditFlags_NoTooltip | ImGuiColorEditFlags_NoPicker);
        ImGui::SameLine();
