...
namespace Tools {
    ...
    struct MADGINE_TOOLS_EXPORT Inspector : Tool<Inspector> {
        ...
        std::pair<bool, bool> drawValue(std::string_view id, ScopePtr &scope, bool editable, ValueTypeDesc *type = nullptr, ExtendedValueTypeDesc possibleTypes = { ExtendedValueTypeEnum::GenericType });
        std::pair<bool, bool> drawValue(std::string_view id, OwnedScopePtr &scope, bool editable, ValueTypeDesc *type = nullptr, ExtendedValueTypeDesc possibleTypes = { ExtendedValueTypeEnum::GenericType });
        std::pair<bool, bool> drawValue(std::string_view id, ObjectPtr &object, bool editable, ValueTypeDesc *type = nullptr, ExtendedValueTypeDesc possibleTypes = { ExtendedValueTypeEnum::GenericType });
