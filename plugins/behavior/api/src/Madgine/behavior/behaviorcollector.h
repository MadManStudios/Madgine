...
namespace Behavior {
    ...
    struct BehaviorFactoryBase {
        ...
        virtual std::vector<Reflect::ExtendedType> parameterTypes(const UniqueOpaquePtr &handle) const = 0;
        virtual std::vector<Reflect::ExtendedType> resultTypes(const UniqueOpaquePtr &handle) const = 0;
