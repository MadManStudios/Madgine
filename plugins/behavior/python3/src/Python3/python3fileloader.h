...
namespace Behavior {
    namespace Python3 {
        ...
        struct MADGINE_PYTHON3_EXPORT Python3FileLoader : Resources::ResourceLoader<Python3FileLoader, PyModulePtr, std::list<Placeholder<0>>> {
            ...
            Reflect::Result find_spec(Reflect::Value &result, std::string_view name, std::optional<std::string_view> import_path, std::optional<Reflect::ObjectPtr> target_module);
