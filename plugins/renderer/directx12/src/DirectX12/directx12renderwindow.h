...
namespace Render {
    ...
    struct MADGINE_DIRECTX12_EXPORT DirectX12RenderWindow : DirectX12RenderTarget {
        DirectX12RenderWindow(DirectX12RenderContext *context, Platform::Window::OSWindow *w, size_t samples);
    ...
    private:
        ...
        Platform::ReleasePtr<IDXGISwapChain3> mSwapChain;

        OffsetPtr mCachedTargetViews[2];
        Platform::ReleasePtr<ID3D12Resource> mBackBuffers[2];
