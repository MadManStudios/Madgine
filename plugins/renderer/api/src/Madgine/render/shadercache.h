...
namespace Render {
    ...
    struct MADGINE_RENDER_EXPORT ShaderCache {
        ...
        static Platform::Filesystem::Path directory();

        static Threading::Task<bool> generate(const Platform::Filesystem::Path &path, ShaderObjectPtr object, std::string_view target, ShaderType type);
