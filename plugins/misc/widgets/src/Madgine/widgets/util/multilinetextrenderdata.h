...
namespace Widgets {
    ...
    struct MultilineTextRenderData : TextRenderData {
        ...
        void renderSelection(WidgetsRenderData &renderData, Vector2 pos, Vector3 size, const Atlas2::Entry &entry, int selectionStart, int selectionEnd, ColorFrame color);
