...
(() => {
  ...
  loadPackage({
    "files": [ {
      "filename": "/data/Band.png",
      "start": 0,
      "end": 279834
    }, {
      "filename": "/data/Band20.fbx",
      "start": 279834,
      "end": 319254
    }, {
      "filename": "/data/Brick.fbx",
      "start": 319254,
      "end": 349346
    }, {
      "filename": "/data/Data-LICENSES.txt",
      "start": 349346,
      "end": 353800
    }, {
      "filename": "/data/Gamepad.jpg",
      "start": 353800,
      "end": 462256
    }, {
      "filename": "/data/NodeGraph.png",
      "start": 462256,
      "end": 464502
    }, {
      "filename": "/data/OpenSans.msdf",
      "start": 464502,
      "end": 17311134
    }, {
      ...
      "filename": "/data/Rock_034_Base_Color.jpg",
      "start": 17345130,
      "end": 17635963
    }, {
      "filename": "/data/blank_white.png",
      "start": 17635963,
      "end": 17636082
    }, {
      "filename": "/data/default.atl",
      "start": 17636082,
      "end": 17636167
    }, {
      "filename": "/data/default.layout",
      "start": 17636167,
      "end": 17637841
    }, {
      "filename": "/data/default_tex.png",
      "start": 17637841,
      "end": 17638046
    }, {
      "filename": "/data/gameover.widget",
      "start": 17638046,
      "end": 17640217
    }, {
      "filename": "/data/grid.png",
      "start": 17640217,
      "end": 17640369
    }, {
...
// end include: /tmp/tmp0499z13d.js
 ...
 */ function getModuleInfo(module) {
  ...
  if (buildId0) {
    ...
    buildId = Array.from(firstBuildId).reduce((acc, x) => acc + x.toString(16).padStart(2, "0"), "");
  }
...
function patchWebAssembly() {
  if ("instantiateStreaming" in WebAssembly) {
    ...
    WebAssembly.instantiateStreaming = function instantiateStreaming(response, importObject) {
      return Promise.resolve(response).then(response => origInstantiateStreaming(response, importObject).then(rv => {
        if (response.url) {
  ...
  if ("compileStreaming" in WebAssembly) {
    ...
    WebAssembly.compileStreaming = function compileStreaming(source) {
      return Promise.resolve(source).then(response => origCompileStreaming(response).then(module => {
        if (response.url) {
...
const INTEGRATION_NAME = "Wasm", _wasmIntegration = () => ({
  name: "Wasm",
  processEvent(e) {
    let t = !1;
    return e.exception?.values && e.exception.values.forEach((e => {
      e.stacktrace?.frames && (t = t || patchFrames(e.stacktrace.frames));
    })), t && (e.debug_meta = e.debug_meta || {}, e.debug_meta.images = [ ...e.debug_meta.images || [], ...getImages() ]), 
    e;
  }
}), wasmIntegration = _wasmIntegration, PARSER_REGEX = /^(.*?):wasm-function\[\d+\]:(0x[a-fA-F0-9]+)$/;
...
function patchFrames(e) {
  ...
  return e.forEach((e => {
    ...
    if (r || (r = e.filename.match(PARSER_REGEX)), r) {
      const a = getImage(r[1]);
      e.instruction_addr = r[2], e.filename = r[1], e.platform = "native", a >= 0 && (e.addr_mode = `rel:${a}`, 
      t = !0);
    }
  })), t;
}
...
}(window, document, "error", "unhandledrejection", "Sentry", "f374f10cbc10297d79d8b7be16390381", "https://browser.sentry-cdn.com/8.55.0/bundle.tracing.replay.min.js", {
  "dsn": "https://f374f10cbc10297d79d8b7be16390381@o4508897651785728.ingest.de.sentry.io/4508897675968592",
  "tracesSampleRate": 1,
...
function _eglGetConfigs(display, configs, config_size, numConfigs) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(26, 0, 1, display, configs, config_size, numConfigs);
