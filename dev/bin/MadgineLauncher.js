...
var ASM_CONSTS = {
  1362376: ($0) => { Module.sentry_capture_event(UTF8ToString($0)) },  
 1362422: () => { FS.syncfs( false, function(err) { assert(!err); }); },  
 1362474: () => { FS.mkdir('/cwd'); FS.mount(IDBFS, {}, '/cwd'); FS.syncfs( true, function(err) { assert(!err); _setupDoneImpl(); }); },  
 1362590: () => { if (document.activeElement == Module.canvas) { Module.input.focus(); } },  
 1362661: () => { if (document.activeElement == Module.input) { Module.canvas.focus(); } },  
 1362732: () => { document.body.style.cursor = 'default'; },  
 1362772: () => { document.body.style.cursor = 'text'; },  
 1362809: () => { document.body.style.cursor = 'move'; },  
 1362846: () => { document.body.style.cursor = 'ns-resize'; },  
 1362888: () => { document.body.style.cursor = 'ew-resize'; },  
 1362930: () => { document.body.style.cursor = 'nesw-resize'; },  
 1362974: () => { document.body.style.cursor = 'nwse-resize'; },  
 1363018: () => { document.body.style.cursor = 'grab'; },  
 1363055: () => { document.body.style.cursor = 'not-allowed'; },  
 1363099: () => { Module.input.focus(); },  
 1363121: () => { Module.canvas.focus(); }
};
var wasmImports = {
  /** @export */
