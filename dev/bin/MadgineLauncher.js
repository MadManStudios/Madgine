...
// end include: /tmp/tmp04rgpqxz.js
...
var ASM_CONSTS = {
  1320424: ($0) => { Module.sentry_capture_event(UTF8ToString($0)) },  
 1320470: () => { FS.syncfs( false, function(err) { assert(!err); }); },  
 1320522: () => { FS.mkdir('/cwd'); FS.mount(IDBFS, {}, '/cwd'); FS.syncfs( true, function(err) { assert(!err); _setupDoneImpl(); }); },  
 1320638: () => { if (document.activeElement == Module.canvas) { Module.input.focus(); } },  
 1320709: () => { if (document.activeElement == Module.input) { Module.canvas.focus(); } },  
 1320780: () => { document.body.style.cursor = 'default'; },  
 1320820: () => { document.body.style.cursor = 'text'; },  
 1320857: () => { document.body.style.cursor = 'move'; },  
 1320894: () => { document.body.style.cursor = 'ns-resize'; },  
 1320936: () => { document.body.style.cursor = 'ew-resize'; },  
 1320978: () => { document.body.style.cursor = 'nesw-resize'; },  
 1321022: () => { document.body.style.cursor = 'nwse-resize'; },  
 1321066: () => { document.body.style.cursor = 'grab'; },  
 1321103: () => { document.body.style.cursor = 'not-allowed'; },  
 1321147: () => { Module.input.focus(); },  
 1321169: () => { Module.canvas.focus(); }
};
var wasmImports = {
  /** @export */
