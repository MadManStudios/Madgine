...
// end include: /tmp/tmplhx6afv5.js
...
var ASM_CONSTS = {
  1173368: ($0) => { Module.sentry_capture_event(UTF8ToString($0)) },  
 1173414: () => { FS.syncfs( false, function(err) { assert(!err); }); },  
 1173466: () => { FS.mkdir('/cwd'); FS.mount(IDBFS, {}, '/cwd'); FS.syncfs( true, function(err) { assert(!err); _setupDoneImpl(); }); },  
 1173582: () => { if (document.activeElement == Module.canvas) { Module.input.focus(); } },  
 1173653: () => { if (document.activeElement == Module.input) { Module.canvas.focus(); } },  
 1173724: () => { Module.input.focus(); },  
 1173746: () => { Module.canvas.focus(); }
};
var wasmImports = {
  /** @export */
