...
// end include: /tmp/tmp_r3k0vfz.js
...
var ASM_CONSTS = {
  1362120: ($0) => { Module.sentry_capture_event(UTF8ToString($0)) },  
 1362166: () => { FS.syncfs( false, function(err) { assert(!err); }); },  
 1362218: () => { FS.mkdir('/cwd'); FS.mount(IDBFS, {}, '/cwd'); FS.syncfs( true, function(err) { assert(!err); _setupDoneImpl(); }); },  
 1362334: () => { if (document.activeElement == Module.canvas) { Module.input.focus(); } },  
 1362405: () => { if (document.activeElement == Module.input) { Module.canvas.focus(); } },  
 1362476: () => { document.body.style.cursor = 'default'; },  
 1362516: () => { document.body.style.cursor = 'text'; },  
 1362553: () => { document.body.style.cursor = 'move'; },  
 1362590: () => { document.body.style.cursor = 'ns-resize'; },  
 1362632: () => { document.body.style.cursor = 'ew-resize'; },  
 1362674: () => { document.body.style.cursor = 'nesw-resize'; },  
 1362718: () => { document.body.style.cursor = 'nwse-resize'; },  
 1362762: () => { document.body.style.cursor = 'grab'; },  
 1362799: () => { document.body.style.cursor = 'not-allowed'; },  
 1362843: () => { Module.input.focus(); },  
 1362865: () => { Module.canvas.focus(); }
};
var wasmImports = {
  /** @export */
