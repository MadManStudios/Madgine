...
// end include: /tmp/tmp69xwd01r.js
...
var ASM_CONSTS = {
  4893116: ($0) => { Module.sentry_capture_event(UTF8ToString($0)) },  
 4893162: () => { FS.syncfs( false, function(err) { assert(!err); }); },  
 4893214: () => { FS.mkdir('/cwd'); FS.mount(IDBFS, {}, '/cwd'); FS.syncfs( true, function(err) { assert(!err); _setupDoneImpl(); }); },  
 4893330: () => { if (document.activeElement == Module.canvas) { Module.input.focus(); } },  
 4893401: () => { if (document.activeElement == Module.input) { Module.canvas.focus(); } },  
 4893472: () => { document.body.style.cursor = 'default'; },  
 4893512: () => { document.body.style.cursor = 'text'; },  
 4893549: () => { document.body.style.cursor = 'move'; },  
 4893586: () => { document.body.style.cursor = 'ns-resize'; },  
 4893628: () => { document.body.style.cursor = 'ew-resize'; },  
 4893670: () => { document.body.style.cursor = 'nesw-resize'; },  
 4893714: () => { document.body.style.cursor = 'nwse-resize'; },  
 4893758: () => { document.body.style.cursor = 'grab'; },  
 4893795: () => { document.body.style.cursor = 'not-allowed'; },  
 4893839: () => { Module.input.focus(); },  
 4893861: () => { Module.canvas.focus(); }
};
...
var __PyRuntime = Module['__PyRuntime'] = 4323760;
var _Py_EMSCRIPTEN_SIGNAL_HANDLING = Module['_Py_EMSCRIPTEN_SIGNAL_HANDLING'] = 4965592;
var __PyEM_EMSCRIPTEN_TRAMPOLINE_OFFSET = Module['__PyEM_EMSCRIPTEN_TRAMPOLINE_OFFSET'] = 1787848;var ___cpp_exception;
