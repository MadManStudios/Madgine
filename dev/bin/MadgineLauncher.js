...
// end include: /tmp/tmpfpr9ze_d.js
...
var ASM_CONSTS = {
  778616: ($0) => { Module.sentry_capture_event(UTF8ToString($0)) },  
 778662: () => { FS.syncfs( false, function(err) { assert(!err); }); },  
 778714: () => { FS.mkdir('/cwd'); FS.mount(IDBFS, {}, '/cwd'); FS.syncfs( true, function(err) { assert(!err); _setupDoneImpl(); }); }
};
var wasmImports = {
  /** @export */
