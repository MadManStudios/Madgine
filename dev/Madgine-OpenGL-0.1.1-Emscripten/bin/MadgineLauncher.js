...
// end include: /tmp/tmpry8f0g_p.js
...
var ASM_CONSTS = {
  749024: () => { FS.syncfs( false, function(err) { assert(!err); }); },  
 749076: () => { FS.mkdir('/cwd'); FS.mount(IDBFS, {}, '/cwd'); FS.syncfs( true, function(err) { assert(!err); _setupDoneImpl(); }); }
};
var wasmImports = {
  /** @export */
