...
set(CMAKE_CXX_FLAGS_INIT "-mtail-call -fwasm-exceptions -pthread")
set(CMAKE_C_FLAGS_INIT "-mtail-call -fwasm-exceptions -pthread")
set(CMAKE_EXE_LINKER_FLAGS_INIT "-s ERROR_ON_UNDEFINED_SYMBOLS=1 -s ALLOW_MEMORY_GROWTH=1 -s MIN_WEBGL_VERSION=2 -s MAX_WEBGL_VERSION=2 -sGL_ASSERTIONS=1 -sFETCH -fwasm-exceptions -sEXCEPTION_STACK_TRACES -sEXCEPTION_DEBUG -pthread -sPTHREAD_POOL_SIZE=8 -sPTHREADS_DEBUG")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-s SIDE_MODULE=1 -s EXPORT_ALL=1 -s ERROR_ON_UNDEFINED_SYMBOLS=1 -fwasm-exceptions -sEXCEPTION_STACK_TRACES -sEXCEPTION_DEBUG -pthread -sPTHREAD_POOL_SIZE=8 -sPTHREADS_DEBUG")
set(CMAKE_CXX_FLAGS_RELEASE_INIT "-DNDEBUG -O3")
set(CMAKE_C_FLAGS_RELEASE_INIT "-DNDEBUG -O3")
...
set(CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO_INIT "-g")
