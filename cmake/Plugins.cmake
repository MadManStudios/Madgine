...
macro(add_plugin name base type)
	...
	if (PLUGIN_CONFIG_STUB)
		...
		foreach(element ${PLUGIN_CONFIG_UNIQUE_COMPONENTS})
			...
			elseif(NOT stubs_registry)
				...
				set(stubs_acc "${stubs_acc}UNIQUECOMPONENT_STUB(${element}, ${stubs_registry}, ${virtual_base});")
				set(stubs_registry )
				set(virtual_base )
			endif()
		endforeach()
	...
	if (NOT MODULES_ENABLE_PLUGINS AND NOT PLUGINS_${type}_${name})		
		...
		install_runtime_artifacts(${PLUGIN_CONFIG_INSTALL_COMPONENT} ${PLUGIN_CONFIG_IMPORTED_DEPS})
